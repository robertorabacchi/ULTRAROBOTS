...
export async function POST(request: NextRequest) {
  try {
    ...
    if (typeof vittoRaw === 'object' && vittoRaw !== null && !Array.isArray(vittoRaw)) {
        ...
        vitto = {
            pranzoPosto: (vittoRaw as any).pranzoPosto || 'N/D',
            pranzoImporto: (vittoRaw as any).pranzoImporto || 'N/D',
            cenaPosto: (vittoRaw as any).cenaPosto || 'N/D',
            cenaImporto: (vittoRaw as any).cenaImporto || 'N/D'
        };
    } else {
    ...
    if (typeof pernoRaw === 'object' && pernoRaw !== null && !Array.isArray(pernoRaw)) {
        ...
        pernottamento = {
            nomeHotel: (pernoRaw as any).nomeHotel || 'N/D',
            numeroNotti: (pernoRaw as any).numeroNotti || 'N/D',
            importo: (pernoRaw as any).importo || 'N/D'
        };
    } else {
        pernottamento = {
            nomeHotel: 'N/D',
